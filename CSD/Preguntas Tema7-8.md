...
|||
| --- |  --- |
|  Por  comunicación directa se entiende  que un proceso se  envía un mensaje a  sí  mismo  directamente,  y  por  comunicación  indirecta  que  se  lo  envía  a  otro  procesodiferente. | F |
|  En  el envío de un mensaje en un sistema  con comunicación sincrónica en la  respuesta,  el  emisor  esperará  hasta  que  el  receptor  haya  procesado  el  mensaje  ydevuelva  la  respuesta. | V |
