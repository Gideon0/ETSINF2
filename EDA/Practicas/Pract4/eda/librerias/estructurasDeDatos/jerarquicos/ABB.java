...
public class ABB<E extends Comparable<E>> {
     ...
     */
    public ABB(E[] v) {        
        this.raiz = construirEquilibrado(v, 0, v.length);       
    }
    ...
    protected NodoABB<E> construirEquilibrado(E[] v, int ini, int fin) {
        ...
        NodoABB<E> izq = construirEquilibrado(v, ini, middle - 1);
        NodoABB<E> der = construirEquilibrado(v, middle + 1, fin);
        
        return new NodoABB<E>(v[middle], izq, der);
    }
    ...
    public void reconstruirEquilibrado() {        
           ...
           this.raiz = construirEquilibrado(array, 0, array.length - 1 );        
    }
